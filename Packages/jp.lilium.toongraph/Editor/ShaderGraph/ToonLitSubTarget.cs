// based on: UniversalLitSubTarget.cs
using System;
using System.Linq;
...
{
    sealed class UniversalLitSubTarget : ToonSubTarget, ILegacyTarget
    {
        ...
        {
            var universalTarget = (target as ToonTarget);
        ...
        {     
            ...
            public static SubShaderDescriptor LitComputeDotsSubShader(ToonTarget target, WorkflowMode workflowMode, string renderType, string renderQueue, bool complexLit)
            {
                SubShaderDescriptor result = new SubShaderDescriptor()
                {
                    ...
                    customTags = ToonTarget.kLitMaterialTypeTag,
            ...
            public static SubShaderDescriptor LitGLESSubShader(ToonTarget target, WorkflowMode workflowMode, string renderType, string renderQueue, bool complexLit)
            {
                // SM 2.0, GLES
        ...
        {
            static void AddWorkflowModeControlToPass(ref PassDescriptor pass, ToonTarget target, WorkflowMode workflowMode)
            {
                if (target.allowMaterialOverride)
            ...
            static void AddReceiveShadowsControlToPass(ref PassDescriptor pass, ToonTarget target, bool receiveShadows)
            {
                if (target.allowMaterialOverride)
            ...
            public static PassDescriptor Forward(ToonTarget target, WorkflowMode workflowMode, PragmaCollection pragmas = null)
            {
            ...
            public static PassDescriptor GBuffer(ToonTarget target, WorkflowMode workflowMode)
            {
                var result = new PassDescriptor
                {
                    // Definition
            ...
            public static PassDescriptor Meta(ToonTarget target)
            {
                var result = new PassDescriptor()
                {
                    // Definition
            ...
            public static PassDescriptor _2D(ToonTarget target)
            {
                var result = new PassDescriptor()
                {
                    // Definition
            ...
            public static PassDescriptor DepthNormal(ToonTarget target)
            {
                var result = new PassDescriptor()
                {
                    // Definition
            ...
            public static PassDescriptor DepthNormalOnly(ToonTarget target)
            {
                var result = new PassDescriptor()
                {
                    // Definition
        ...
        static class LitRequiredFields
        {
            public static readonly FieldCollection Forward = new FieldCollection()
            {
                ...
                ToonStructFields.Varyings.fogFactorAndVertexLight, // fog and vertex lighting, vert input is dependency
                ToonStructFields.Varyings.shadowCoord,             // shadow coord, vert input is dependency
            };
