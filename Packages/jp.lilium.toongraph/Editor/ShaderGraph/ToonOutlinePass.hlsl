...
//
// based on: com.unity.render-pipelines.universal@10.2.2\Editor\ShaderGraph\Includes\Varyings.hlsl
//
Varyings BuildVaryingsToon(Attributes input)
{
    ...
    input.positionOS = vertexDescription.OutlinePosition;
...
{
    Varyings output = (Varyings)0;
    output = BuildVaryingsToon(input);
...
{    
    ...
    return half4(surfaceDescription.OutlineColor, alpha);
}
